...
open class KDCircularProgress: UIView {
    ...
    fileprivate class KDCircularProgressViewLayer: CALayer {
        ...
        override func draw(in ctx: CGContext) {
            ...
            let imageCenter = CGPoint(x: size.width/2.0, y: size.height/2.0)
            imageCtx?.addArc(center: imageCenter, radius: arcRadius, startAngle: fromAngle, endAngle: toAngle, clockwise: true)
            ...
            if colorsArray.count > 1 {
                ...
                for color in rgbColorsArray {
                    ...
                    componentsArray += colorComponents!
                }
